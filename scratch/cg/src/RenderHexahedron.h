#ifndef __RENDER_HEXAHEDRON_H__
#define __RENDER_HEXAHEDRON_H__
...
/**
 * Render a hexahedral cell onto a render object.
 * @param ren    parent vtkRenderer object
 * @param coords TBA
 * @param dofs   TBA
 */
void RenderHexahedron(vtkRenderer *ren)
{
    assert(ren != 0);
    ...
    double dofs[nno] = {2.7, 4.1, 5.3, 3.4, 0.0, 0.0, 0.0, 0.0};
